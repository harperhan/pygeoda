...
def hinge15_breaks(data,**kwargs):
    ...
    Note:
        ...
        The map menu has two entries for the box map, one for each option for the hinges (1.5 and 3.0), identical to what we had for the box plot. 
        Here the hinges equal to 1.5  
